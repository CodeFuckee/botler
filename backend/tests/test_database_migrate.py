...
class TestMigrateInspirations:
    ...
    def test_old_db_gets_inspirations_table(self, tmp_path):
        ...
        assert ver == 20, f"user_version 应推进到 20（v16 task_usage + v17 base_sha + v18 failure_category + v19 issue_manual_orders + v20 tools/tool_meta，issue #287/#172），实际 {ver}"
